...
class board_mv64560(discovery_v_sc):
    ...
    def add_objects(self):
        ...
        # Device CS 0
        led_swt = self.add_pre_obj('led_swt', 'db64560_leds_swt')
        ...
        # AFDX ES
        pci_bus0 = self.get_slot('pci_bus[0]')
        afdxES = self.add_pre_obj('afdxES', 'afdxES')

        afdxES_phy0 = self.add_pre_obj('afdxES_phy0','generic_eth_phy')
        afdxES_phy0.phy_id = 0x000fc6c8
        afdxES_phy0.address = 5
        afdxES_phy0.mac = afdxES
        afdxES.phy = afdxES_phy0
        afdxES_mii = self.add_pre_obj('afdxES_mii',  'mii-management-bus')
        afdxES.mii_bus = afdxES_mii
        afdxES_mii.devices = [[afdxES_phy0, 0]]
        pci_bus0.pci_devices += [[18, 0, afdxES]]
        afdxES.pci_bus = pci_bus0
